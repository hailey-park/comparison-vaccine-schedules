...
age_0_17_specs <- data.frame(prior_vacc=c("unvax","unvax","fullvax", "fullvax", "boosted_1st", "boosted_2nd", "boosted_1st", "boosted_2nd", "boosted_1st", "boosted_2nd", "fullvax"), 
                           ...
                           ntimes=c(0.086, 0.332, 0.121, 0.3, 0.066 * (1-0.476), 0.066 * 0.476, 0.074 * (1-0.476), 0.074 * 0.476004, 0.009 * (1-0.476), 0.009 * 0.47601, 0.012) * (pop_size*0.2176))
...
age_18_29_specs <- data.frame(prior_vacc=c("unvax","unvax","fullvax", "fullvax", "boosted_1st", "boosted_2nd", "boosted_1st", "boosted_2nd", "boosted_1st", "boosted_2nd", "fullvax"), 
                             prior_inf=c("inf","reinf","inf","reinf","inf", "inf", "reinf", "reinf", "noinf", "noinf", "noinf"), 
                             ntimes=c(0.046, 0.177, 0.1, 0.246, 0.175 * (1-0.388), 0.175 * 0.388, 0.194 * (1-0.388), 0.194 * 0.388002, 0.043 * (1-0.388), 0.043 * 0.388, 0.019) * (pop_size*0.157))
...
age_30_49_specs <- data.frame(prior_vacc=c("unvax","unvax","fullvax", "fullvax", "boosted_1st", "boosted_2nd", "boosted_1st", "boosted_2nd", "boosted_1st", "boosted_2nd", "fullvax"), 
                              prior_inf=c("inf","reinf","inf","reinf","inf", "inf", "reinf", "reinf", "noinf", "noinf", "noinf"), 
                              ntimes=c(0.026, 0.101, 0.074, 0.185, 0.232 * (1-0.271), 0.232 * 0.271, 0.258 * (1-0.271), 0.258 * 0.271001, 0.1 * (1-0.271), 0.1 * 0.271, 0.024) * (pop_size*0.2621))
...
age_50_64_specs <- data.frame(prior_vacc=c("unvax","unvax","fullvax", "fullvax", "boosted_1st", "boosted_2nd", "boosted_1st", "boosted_2nd", "boosted_1st", "boosted_2nd", "fullvax"), 
                              prior_inf=c("inf","reinf","inf","reinf","inf", "inf", "reinf", "reinf", "noinf", "noinf", "noinf"), 
                              ntimes=c(0.022, 0.085, 0.048, 0.118, 0.274 * (1-0.420), 0.274 * 0.4200012, 0.304 * (1-0.420), 0.304 * 0.420, 0.131 * (1-0.420), 0.131 * 0.420, 0.018) * (pop_size*0.1868))
...
age_65_74_specs <- data.frame(prior_vacc=c("unvax","unvax","fullvax", "fullvax", "boosted_1st", "boosted_2nd", "boosted_1st", "boosted_2nd", "boosted_1st", "boosted_2nd", "fullvax"), 
                              prior_inf=c("inf","reinf","inf","reinf","inf", "inf", "reinf", "reinf", "noinf", "noinf", "noinf"), 
                              ntimes=c(0.016, 0.06, 0.035, 0.086, 0.272 * (1-0.686), 0.272 * 0.686003, 0.303 * (1-0.686), 0.303 * 0.686, 0.208 * (1-0.686), 0.208 * 0.686, 0.02) * (pop_size*0.1035))
...
age_75plus_specs <- data.frame(prior_vacc=c("unvax","unvax","fullvax", "fullvax", "boosted_1st", "boosted_2nd", "boosted_1st", "boosted_2nd", "boosted_1st", "boosted_2nd", "fullvax"), 
                              prior_inf=c("inf","reinf","inf","reinf","inf", "inf", "reinf", "reinf", "noinf", "noinf", "noinf"), 
                              ntimes=c(0.016, 0.06, 0.035, 0.086, 0.272 * (1-0.736), 0.272 * 0.7360, 0.303 * (1-0.736), 0.303 * 0.736003, 0.208 * (1-0.736), 0.208 * 0.736, 0.02) * (pop_size*0.073))
...
pop5mil <- read_csv("data/clean-data/entire_population_model_initialization_daily_5mil_updated.csv")
############################################################
#PLOTS OF TIME-SINCE EVENT DISTRIBUTION FOR ENTIRE SIMULATED POPULATION

pdf("time-since-plots-50mil.pdf")

# inspection <- read.csv("data/clean-data/entire_population_model_initialization_daily_50mil.csv")[,-1] %>% 
...
for(i in c(1:6)) {
  ...
  inspection <- time_since_results[[i]] %>% 
    ...
    summarise(total = n()) #%>% filter(!is.na(time_since_last_reinf))
