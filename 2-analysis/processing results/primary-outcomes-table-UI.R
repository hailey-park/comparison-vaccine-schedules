...
setwd("~/Desktop/final-analysis/simulation-results/realistic")
strat_0 <- lapply(grep(grep(list.files('~/Desktop/final-analysis/simulation-results/realistic'), pattern = "lower|upper", invert = TRUE, value = TRUE), pattern = "strat_0", value = TRUE), read.csv, header=T, sep=',', dec='.')%>%
  lapply(cleaning_sim_general)

strat_1 <- lapply(grep(grep(list.files(), pattern = "lower|upper", invert = TRUE, value = TRUE), pattern = "strat_1", value = TRUE), read.csv, header=T, sep=',', dec='.')%>%
  lapply(cleaning_sim_general)

strat_2 <- lapply(grep(grep(list.files(), pattern = "lower|upper", invert = TRUE, value = TRUE), pattern = "strat_2", value = TRUE), read.csv, header=T, sep=',', dec='.')%>%
  lapply(cleaning_sim_general)

strat_3 <- lapply(grep(grep(list.files(), pattern = "lower|upper", invert = TRUE, value = TRUE), pattern = "strat_3", value = TRUE), read.csv, header=T, sep=',', dec='.')%>%
  lapply(cleaning_sim_general)

strat_4 <- lapply(grep(grep(list.files(), pattern = "lower|upper", invert = TRUE, value = TRUE), pattern = "strat_4", value = TRUE), read.csv, header=T, sep=',', dec='.')%>%
  lapply(cleaning_sim_general)

strat_5 <- lapply(grep(grep(list.files(), pattern = "lower|upper", invert = TRUE, value = TRUE), pattern = "strat_5", value = TRUE), read.csv, header=T, sep=',', dec='.')%>%
  lapply(cleaning_sim_general)

strat_6 <- lapply(grep(grep(list.files(), pattern = "lower|upper", invert = TRUE, value = TRUE), pattern = "strat_6", value = TRUE), read.csv, header=T, sep=',', dec='.')%>%
  lapply(cleaning_sim_general)

strat_7 <- lapply(grep(grep(list.files(), pattern = "lower|upper", invert = TRUE, value = TRUE), pattern = "strat_7", value = TRUE), read.csv, header=T, sep=',', dec='.')%>%
  lapply(cleaning_sim_general)

strat_8 <- lapply(grep(grep(list.files(), pattern = "lower|upper", invert = TRUE, value = TRUE), pattern = "strat_8", value = TRUE), read.csv, header=T, sep=',', dec='.')%>%
  lapply(cleaning_sim_general)

strat_9 <- lapply(grep(grep(list.files(), pattern = "lower|upper", invert = TRUE, value = TRUE), pattern = "strat_9", value = TRUE), read.csv, header=T, sep=',', dec='.')%>%
  lapply(cleaning_sim_general)

strat_10 <- lapply(grep(grep(list.files(), pattern = "lower|upper", invert = TRUE, value = TRUE), pattern = "strat_10", value = TRUE), read.csv, header=T, sep=',', dec='.')%>%
  lapply(cleaning_sim_general)
...
cleaned_results_mean[c(1:5)] %>% lapply(processing_sim, reference_data = cleaned_results_mean[[2]])
cleaned_results_lower[c(1:5)] %>% lapply(processing_sim, reference_data = cleaned_results_lower[[2]])
cleaned_results_upper[c(1:5)] %>% lapply(processing_sim, reference_data = cleaned_results_upper[[2]])
