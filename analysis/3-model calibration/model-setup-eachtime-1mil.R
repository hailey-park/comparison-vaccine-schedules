...
clean_population_df <- function(df){
  df %>% dplyr::select(c("individual", "age_group", "prior_inf", "risk_group","time_since_last_dose_inf", "time_since_last_dose", "prior_vacc", "vaccine_wave", "second_vaccine_wave", "third_vaccine_wave")) %>%
