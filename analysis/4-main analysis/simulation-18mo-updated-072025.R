...
########################################################################################################################
#This is the one and a half year booster simulation, July 2023-January 2025

boosterSimulation_annual <- function(df){
  
  #Store severe and nonsevere outcome counts in df (547 days since it is year-long simulation)
  ...
  #get indexes by age group and by updated booster vaccine coverages
  ...
  for (i in (1:547)) {
    ...
    input$vax_status <- as.integer(as.logical(input$vax == 1 & input$vax_val == 1))
    input$vax_day1 <- as.integer(as.logical(((vaccine_wave < i & vaccine_wave != 0) | (second_vaccine_wave < i & second_vaccine_wave != 0) | (vaccine_wave_val < i & vaccine_wave_val != 0)) & severe_outcomes == 1 & input$vax_status == 1))
    input$vax_nonsevere_day1 <- as.integer(as.logical(((vaccine_wave < i & vaccine_wave != 0) | (second_vaccine_wave < i & second_vaccine_wave != 0) | (vaccine_wave_val < i & vaccine_wave_val != 0)) & nonsevere_outcomes == 1 & input$vax_status == 1))
    ...
    grouped_outcomes <- input %>% 
      group_by(age_group, risk_group) %>% summarise(total_severe = sum(day1),
                                                    ...
                                                    total_vaccines = sum(vax) + sum(vax_2) + sum(vax_val),
...
boosterSimulation_semiannual_strat_5_7 <- function(df){
  ...
  for (i in (1:547)) {
    ...
    input$day1 <- severe_outcomes
    input$nonsevere_day1 <- nonsevere_outcomes
    input$vax_status <- as.integer(as.logical(input$vax == 1 & input$vax_2 == 1 & input$vax_val == 1))
    input$vax_day1 <- as.integer(as.logical(((vaccine_wave < i & vaccine_wave != 0) | (second_vaccine_wave < i & second_vaccine_wave != 0) | (vaccine_wave_val < i & vaccine_wave_val != 0)) & severe_outcomes == 1 & input$vax_status == 1))
    input$vax_nonsevere_day1 <- as.integer(as.logical(((vaccine_wave < i & vaccine_wave != 0) | (second_vaccine_wave < i & second_vaccine_wave != 0) | (vaccine_wave_val < i & vaccine_wave_val != 0)) & nonsevere_outcomes == 1 & input$vax_status == 1))
...
boosterSimulation_semiannual_strat_8_9_10 <- function(df){
  ...
  for (i in (1:547)) {
    ...
    input$nonsevere_day1 <- nonsevere_outcomes
    input$vax_status <- as.integer(as.logical(input$vax == 1 & input$vax_2 == 1 & input$vax_val == 1))
    input$vax_status[which(age %in% c("0-17 years", "18-29 years", "30-49 years", "50-64 years") & risk %in% c("healthy", "higher risk") & input$vax == 1 & input$vax_val == 1)] <- 1
    input$vax_day1 <- as.integer(as.logical(((vaccine_wave < i & vaccine_wave != 0) | (second_vaccine_wave < i & second_vaccine_wave != 0) | (vaccine_wave_val < i & vaccine_wave_val != 0)) & severe_outcomes == 1 & input$vax_status == 1))
    input$vax_nonsevere_day1 <- as.integer(as.logical(((vaccine_wave < i & vaccine_wave != 0) | (second_vaccine_wave < i & second_vaccine_wave != 0) | (vaccine_wave_val < i & vaccine_wave_val != 0)) & nonsevere_outcomes == 1 & input$vax_status == 1))
